...
describe('analyzer', () => {
  it('parses a filename with default pattern 1', () => {
    ...
    const expected = "t/Testperson_Armeswesen_22.04.1975/2020-06-14_Bericht_Kantonsspital.pdf"
  ...
  it('parses a filename with default pattern 2', () => {
    ...
    const expected = "t/Testperson_Armeswesen_22.04.1975/Bericht_Kantonsspital.pdf"
    an(check).should.equal(expected)
    an(check2).should.equal(expected)
  })
